...
<div class="container w-800">
   <div class="row mt-50">
      <a class="btn" style="background-color: #DEF2FF" href="${pageContext.request.contextPath}/mainCommunity/noticeList">공지사항</a>
      <a class="btn" href="${pageContext.request.contextPath}/mainCommunity/qnaList">Q & A</a>
   </div>
   ...
   <div class="row">
      ...
      <button type="submit" class="btn btn-positive" style="width:70px; height:35px;">
