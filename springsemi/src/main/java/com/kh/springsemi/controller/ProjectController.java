...
//	public String readCountList(Model model, @RequestParam(required = false) String keyword
//			,@RequestParam(required = false, defaultValue="1") int page) {
//		
//		//페이징과 관련된 값들을 계산하여 JSP로 전달 
//		int begin = (page - 1) / 10 * 10 + 1;
//		int end = begin + 9;
//		int count = projectDao.countList(); //목록 개수 or 검색 결과 수를 모름
...
//			List<ProjectListDto> projectList = projectDao.selectList();
	...
	public String LikeCountList(Model model, @ModelAttribute(name="vo") PaginationListVO vo) {
		...
		return "/WEB-INF/views/project/likeCountList.jsp";
	}
