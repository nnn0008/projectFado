...
<div class="container w-700">
	<div class="row mb-30">
		...
		<h1>${memberDto.memberId}서퍼님의 회원 정보</h1>
		<i class="fa-solid fa-heart" style="color: #f2829e;"></i>
	</div>
	...
	<div class="left mt-20">
		<label class="bold mt-10">우편번호</label>
		<br>
		<label>${deliveryDto.diliveryPost}</label>
	</div>
	<hr class="hr-style">
	
	<div class="left mt-20">
		<label class="bold mt-10">주소</label>
		<br>
		<label>${deliveryDto.diliveryAddr1}</label>
		<label>${deliveryDto.diliveryAddr2}</label>
	</div>
	<hr class="hr-style">
